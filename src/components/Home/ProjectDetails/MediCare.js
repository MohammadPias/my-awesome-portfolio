...
import img2 from '../../../images/projects/medicare-3.png'
import img3 from '../../../images/projects/medicare-2.png'
...
const T2P = () => {
    ...
    const linkName = [
        ...
        { name: 'Client side code', path: 'https://github.com/MohammadPias/travel-to-paradise-client' },
    ]
    ...
    return (
        <div >
            <div className='grid grid-cols-1 lg:grid-cols-3 gap-5 w-5/6 mx-auto mt-5 p-5'>
                ...
                <Fade right big>
                    <Fade left big></Fade><div>
                        <div className='text-left'>
                            <h1 className='text-3xl text-gray-200 font-bold'>Medicare Magician</h1>
                            <h2 className="text-lg text-gray-400">
                                Front-end Technologies: React js, JavaScript, React-router, React-bootstrap
                                <br />

                            </h2>
                            <p className="text-gray-300">
                                * A full-stack SPA website where different types of medical services are displayed.
                                <br />
                                * SignIn and SignUp method have been built through Firebase Authentication. After sign in a user can book their services.
                            </p>
